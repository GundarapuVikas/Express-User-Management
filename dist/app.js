...
app.get("/fetch_user/:id", function (req, res) {
...
app.put("/update_user/:id", function (req, res) {
  var userId = req.params.id;
  var updatedLogin = req.body.login;
...
app.post("/addUser", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var user_data, _schema$validate, error, value, Userindex;
...
app.get("/AutoSuggestUsers/:substring/:limit", function (req, res) {
  var listOfMatchedUsers = listOfUsers.filter(function (user) {
    return user.login.match(req.params.substring);
  }).slice(0, req.params.limit);
  if (listOfMatchedUsers.length) {
    res.send(listOfMatchedUsers.sort(function (a, b) {
